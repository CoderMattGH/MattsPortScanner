...
// Struct for Pseudo Header used in TCP check sum calculation
struct psheader {
    ...
    __be16 tcpseglen;   // TCP header + data in bytes
};
...
unsigned char * str_to_mac(char *mac_str);
